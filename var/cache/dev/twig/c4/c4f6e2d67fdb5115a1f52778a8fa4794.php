...
class __TwigTemplate_9812662f9ba264c8e5cabdcf2b820d37 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_type_delete', {'id': type.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ type.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "type/_delete_form.html.twig", "/Users/monkey/Desktop/mon-hop-au-lit/templates/type/_delete_form.html.twig");
    }
}
